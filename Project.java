...
public class Project {
    public static void main(String[] args) {
        ...
        if (mode == 1) { // when user chooses adding and subtracting level
            ...
            System.out.println(", there isn't a mode corresponding to " + mode +  ". Please play again with a valid mode.");
        }
    }
    ...
    public static int ModeChoose(String name) { // Entering the username, and choosing which mode to play
        ...
        while(!kb.hasNextInt()) { // while the input isn't an int
            String incorrect = kb.nextLine(); 
            System.out.print(incorrect + " is not even a whole number agent! Smarten up and choose a mode!\n-> ");
        }
        int mode = kb.nextInt();
        return mode;
    }
